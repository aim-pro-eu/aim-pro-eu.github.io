...
coverImage: /images/uploads/aim-pro-newsletter-cover-small.png
---
...
AIM-PRO is a **groundbreaking project funded under the** **[Erasmus+ Alliance for Innovation](https://erasmus-plus.ec.europa.eu/), partially supported by [Movetia - Exchange and Mobility](https://movetia.ch/en/).** Over **36 months**, starting 1 February 2026, this project brings together **[15 partner](https://aim-pro.eu/#partners) organisations across 9 European countries**, Belgium, France, Germany, Greece, Italy, the Netherlands, Slovenia, Spain, and Sweden, to drive transformative change. 
...
![Learning about the empathy map methodology during the Needs Analysis Workshop led by UNIPI. ](public/images/uploads/aim-pro-empathy-map.png "Learning about the empathy map methodology during the Needs Analysis Workshop led by UNIPI. ")
...
Eftychia Roumelioti and Annapaola Marconi (FBK) presented a competency-driven gamification approach drawing on lessons from prior Erasmus+ projects ([StandByMe](https://www.standbymeproject.eu/) and [Cesagram](https://cesagramproject.eu/)). The strategy incorporates AI ethics quests, Green AI challenges, adaptive learning pathways, and collaborative mechanics to sustain engagement across HE, VET, and SME learners. 
