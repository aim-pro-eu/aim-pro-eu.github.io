<template>
  <div class="zenodo-publications w-full max-w-5xl mx-auto py-8">
    ...
    <div v-if="loading" class="flex justify-center items-center py-12">
      ...
      <span class="ml-3 text-gray-600 font-medium">Chargement des publications...</span>
    </div>
    ...
    <div v-else>
      ...
      <div v-if="nextPageUrl" class="mt-8 flex justify-center">
        ...
        >
          ...
          <span v-else>Afficher plus de publications</span>
        </button>
      </div>
    </div>
    ...
    <div v-if="!loading && !error && publications.length === 0" class="text-center py-12 bg-gray-50 rounded-lg border border-gray-200">
      <p class="text-gray-500 text-lg">Aucune publication trouvée pour cette communauté.</p>
    </div>
  </div>
</template>
